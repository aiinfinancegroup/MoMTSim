...
import org.momtsim.identity.IdentityFactory;
...
public abstract class MoMTSimState extends SimState {
    public static final double MOMTSIM_VERSION = 0.01;


    private final Logger logger = LoggerFactory.getLogger(MoMTSimState.class);
    ...
    public MoMTSimState(Parameters parameters) {
    ...
    private void initActors() {
        ...
        for (int i = 0; i < num3rdPartyFraudsters; i++) {
            ...
            DirectDepositFraudster f = new DirectDepositFraudster(this, idFactory.nextPerson());
