 ...
 */
public class RefundFraudster extends SuperActor implements HasClientIdentity, Identifiable, Steppable {
    ...
    public RefundFraudster(MoMTSimState state, ClientIdentity identity) {
        super(state);
