 ...
 * add to the queue.
 * <p>
 * For an example of using IteratingMoMTSim, see the provided main() method.
 */
public class IteratingMoMTSim extends MoMTSimState implements Iterator<Transaction> {

    private final Logger logger = LoggerFactory.getLogger(IteratingMoMTSim.class);
    ...
    public IteratingMoMTSim(Parameters parameters, int queueDepth, String workerName) {
        super(parameters);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Starting an instance of IteratingMoMTSim...");
        Parameters parameters = new Parameters("MoMTSim.properties");

        long startTime = System.currentTimeMillis();
        IteratingMoMTSim sim = new IteratingMoMTSim(parameters);
        sim.run();
        ...
        System.out.println("Hi 👋 from Denish");
    }
